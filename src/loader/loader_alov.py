...
class loader_alov:
    ...
    def loaderAlov(self):
        ...
        for i, alov_sub_folder in enumerate(alov_subdirs):
            ...
            logger.info('Loading {:>3} of {:>3} - annotation file from folder = {:>4}'.format(i + 1, len(alov_subdirs),
                                                                                              alov_sub_folder))
    ...
    def load_annotation_file(self, alov_sub_folder, annotation_file):
        ...
        with open(annotation_file, 'r') as f:
            ...
            for bb in data:
                ...
                frame_num, ax, ay, bx, by, cx, cy, dx, dy = int(frame_num), float(ax), float(ay), float(bx), float(
...
if '__main__' == __name__:
    ...
    objLoaderAlov = loader_alov('./ALOV/images/',
                                './ALOV/gt/', logger)
