...
class loader_imagenet:
    ...
    def loaderImageNetDet(self):
        ...
        for i, imgnet_sub_folder in enumerate(imagenet_subdirs):
            ...
            logger.info('Loading {}/{} - annotation file from folder = {}'.format(i + 1, len(imagenet_subdirs),
                                                                                  imgnet_sub_folder))
    ...
    def find_subfolders(self, imagenet_folder):
        ...
        return [dir_name for dir_name in os.listdir(imagenet_folder) if
                os.path.isdir(os.path.join(imagenet_folder, dir_name))]
    ...
    def load_annotation(self, image_num, annotation_num):
        ...
        if img_height != random_ann.disp_height or img_width != random_ann.disp_width:
            logger.info('Image Number = {}, Annotation Number = {}, Image file = {}'.format(image_num, annotation_num,
                                                                                            img_path))
...
if '__main__' == __name__:
    ...
    objLoaderImgNet = loader_imagenet('./ILSVRC2014/images/',
                                      './ILSVRC2014/gt/', logger)
